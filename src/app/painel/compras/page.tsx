  ...
  return (
    <AppShell>
      ...
      <section className="daddus-metric-grid">
        <Metric icon={<ClipboardList />} label="Processos ativos" value={String(demoProcessos.length).padStart(2, "0")} note={`${emCotacao} em fase de cotacao`} />
            ...
            <table className="daddus-table">
              ...
              <tbody>
                ...
                {!processosFiltrados.length && (
                  <tr><td colSpan={5} className="daddus-empty">Nenhum processo encontrado para &ldquo;{busca}&rdquo;.</td></tr>
                )}
              </tbody>
            </table>
          </div>
